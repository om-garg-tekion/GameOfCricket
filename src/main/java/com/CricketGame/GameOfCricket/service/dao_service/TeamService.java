...
public class TeamService {
    ...
    public List<Team> saveTeams(List<Team> teams) { return this.teamRepository.saveAll(teams); }

    public Team findById(Long id){ return this.teamRepository.findById(id).orElse(null); }
}
